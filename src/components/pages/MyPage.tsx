...
import profile_me from "../img/IMG_4151.jpg";
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1 className="m-0 text-dark">マイページ</h1>
              </div>
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  <li className="breadcrumb-item"><a href="#">Home</a></li>
                  <li className="breadcrumb-item active">マイページ</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div className="col-md-3">
                ...
                <div className="card card-primary card-outline">
                  <div className="card-body box-profile">
                    <div className="text-center">
                      <img className="profile-user-img img-fluid img-circle" src={profile_me} alt="User profile picture" />
                    </div>

                    <h3 className="profile-username text-center">Hiroki Okazaki</h3>

                    <p className="text-muted text-center">アプリ制作のお話があれば是非〜</p>

                    <ul className="list-group list-group-unbordered mb-3">
                      <li className="list-group-item">
                        <b>メモ帳 </b><i className="fas fa-journal-whills"></i> <a className="float-right">1,322</a>
                      </li>
                      <li className="list-group-item">
                        <b>羽ペン</b><i className="fas fa-feather"></i> <a className="float-right">543</a>
                      </li>
                      <li className="list-group-item">
                    ...
                    <a href="#" className="btn btn-primary btn-block"><b>編集する</b></a>
                  </div>
                ...
                <div className="card card-primary">
                  ...
                  <div className="card-body">
                    <strong><i className="fas fa-book mr-1"></i>CAN</strong>

                    <p className="text-muted">Webアプリ制作</p>

                    <hr />

                    <strong><i className="fas fa-map-marker-alt mr-1"></i> Location</strong>

                    <p className="text-muted">千葉県</p>

                    <hr />

                    <strong><i className="fas fa-pencil-alt mr-1"></i>CAN</strong>

                    <p className="text-muted">
                      <span className="tag tag-danger">Webアプリ制作</span>
                    ...
                    <p className="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam fermentum enimneque.</p>
                  </div>
